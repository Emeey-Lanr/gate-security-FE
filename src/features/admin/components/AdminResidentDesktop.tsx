      ...
      <table className="min-w-[1000px] table-fixed">
        <thead className="">
          <tr>
            ...
            <th className="text-sm font-normal text-left p-[8px]">
              RESIDENT ID
            </th>
            <th className="text-sm font-normal text-left w-[250px] p-[8px]">
              HOME ADDRESS
            </th>
        ...
        <tbody>
          <tr
            onClick={() => alert(20)}
            className="  bg-[#fdfdfd] p-[8px] h-[48px] box-border  border border-[#303030] shadow-sm rounded-md "
          >
            <td className="p-[8px]">
            ...
            <td className="p-[8px]">
              <p className="text-[#333] text-sm truncate">08126115740</p>
            </td>
            <td className=" p-[8px] ">
              <p className="text-[#333] text-sm truncate">RES-001 030</p>
            </td>
            <td className="p-[8px]">
              <p className="text-[#333] text-sm truncate">
            ...
            <td className="p-[8px] ">
              <p className="text-xs flex items-center gap-1 text-[#333]">
