...
const AdminSignin = () => {
 ...
 <AdminLogo/>
     ...
     <h1 className="text-[24px] font-medium pb-[2px] lg:text-[42px]">ADMIN SIGNIN</h1>
     <p className="text-sm font-light lg:text-[16px]">Sign in to your admin account.</p>
      </header>
...
<form className="relative mt-[14px] lg:w-[80%] lg:mx-auto" onSubmit={handleSubmit(onSubmit)}>
  ...
  <div className="mb-[8px] relative">
   ...
   <div className="mt-[16px]">
    ...
    <p className="text-sm font-light text-center mt-[16px]">Don't have an account ?  <button className="font-bold" onClick={()=>navigate("/admin/signup")}>Signup</button></p>
     </form>
