      ...
      <div>
        ...
        <div className="mt-[16px]">
          ...
          <div className="w-[100px] mx-auto flex gap-1 bg-[#2c2c2c] border border-[#a7a7a7] p-[8px] rounded-md mt-[8px]">
            <button className="w-[20px] h-[20px]  bg-[#1B1B1B] text-white  border border-[#a7a7a7] text-xs">
              1
            </button>
            <button className="w-[20px] h-[20px] text-[#666]  text-xs">
              2
            </button>
            <button className="w-[20px] text-xs text-[#666] h-[20px] ">
              3
            </button>
          </div>
        </div>
...
export default AdminAllResidents;
