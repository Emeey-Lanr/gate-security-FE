      ...
      <div className="py-[16px] mx-auto">
        ...
        <div className="md:grid md:grid-cols-2 lg:grid-cols-4 gap-[16px] mt-[16px] ">
          <div className="p-[10px] my-[8px] bg-[#fdfdfd] rounded-[5px]  border border-[#303030]">
            ...
            <p className="">
              <span className="text-bold text-[34px] font-light text-[#414141]">
                0
              </span>
              <span className="text-xs font-light text-[#414141]">
                {" "}
                resident
              </span>
            </p>
          ...
          <div className="p-[10px] my-[8px] bg-[#b0f0aa31] rounded-[5px]  border border-[#b0f0aa]">
            ...
            <p className="">
              <span className="text-bold text-[34px] font-light text-[#5bfd4c]">
                0
              </span>
              <span className="text-xs font-light"> Active</span>
            </p>
          </div>
          ...
          <div className="p-[10px] my-[8px] bg-[#ffbbbb3d] rounded-[5px]  border border-[#f0aaaa]">
            ...
            <p className="">
              <span className="text-bold text-[34px] font-light text-[#ff5757]">
                0
              </span>
              <span className="text-xs font-light"> Active</span>
            </p>
